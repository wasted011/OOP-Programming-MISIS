...
test_demo_object_02 = Car(_brand="Honda", _model="Civic", _mileage=45000, _year_of_manufacture=date(2000, 1, 1))
...
def demo_incorrect_initialization(variable: tuple) -> None | str:  
    ...
    try:
        ...
        Car(_brand=variable[0], _model=variable[1], _mileage=variable[2], _year_of_manufacture=variable[3])
...
demo_object_06 = Car(_brand="Toyota", _model="Camry", _mileage=50000, _year_of_manufacture=date(2015, 1, 1))
...
scenario_04 = Car(_brand="Porshe", _model="Panamera", _mileage=10000, _year_of_manufacture=date(2024, 1, 1))
