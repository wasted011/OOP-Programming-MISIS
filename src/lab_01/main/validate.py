...
def validate_car_brand_model(variable: str) -> bool:

    return isinstance(variable, str) or len(variable.split()) != 0
...
def validate_mileage(variable: int) -> bool:
    ...
    return isinstance(variable, int) or variable >= 0

def validate_year_of_manufacture(variable: date) -> bool:

    return isinstance(variable, date) or variable <= date.today()

def validate_car_funcs_drive_mode(drive_mod: str) -> bool:

    return isinstance(drive_mod, str) or len(drive_mod.split()) != 0
...
def validate_distance(distance: int) -> bool:
    ...
    return isinstance(distance, int) or distance >= 0
